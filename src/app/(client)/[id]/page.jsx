...
const BlogsDetails = ({ params }) => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 md:px-0 mt-10">
      <div className="">
        ...
        >
          <div className="bg-black/60 rounded-2xl absolute w-full h-full top-0 left-0 flex flex-col items-center gap-3 sm:gap-5 justify-center px-3 text-center">
            ...
            <p className="text-sm sm:text-base">
              Get updates on the latest posts and more from Random Info straight
              to your inbox.
            </p>
            <form
          ...
          {nextArticles.map((post, idx) => (
            <div key={idx} className="mb-10 sm:mb-16">
              ...
              <div className="py-4 sm:py-5 border-b border-b-neutral-200 flex flex-wrap sm:flex-nowrap items-center gap-2 sm:gap-3 text-sm">
                <p className="text-gray-600 font-normal">Share this article:</p>
              ...
              <div className="pt-6 sm:pt-10 flex flex-col gap-8 sm:gap-10 pb-10">
                {post.content.map((paragraph, idx) => (
                  <div key={idx} className="flex flex-col gap-4 sm:gap-6">
                    ...
                    <p className="text-gray-800 text-base sm:text-lg leading-7">
                      What if your favorite Nigerian celebrities weren’t just
                      stars on stage or screen, but machines on wheels? In this
                      whimsical exploration, we match some of Nigeria’s most
                      beloved celebrities with cars that embody their unique
                      personalities and styles. From sleek sports cars to rugged
                      SUVs, here’s a fun look at which vehicles best represent
